	...
	<div ref="modal" class="modal" :style="`top: ${clientHeight}`">
		<div class="modal__card">
			<div class="modal__header">
				...
				<div
					@click="$store.dispatch('estados/setSinopse', false)"
					class="modal__fechar"
				>
					X
				</div>
			...
			<div class="modal__content">
				<div class="title title--black v-gutter-sm">
...
export default {
	...
	methods: {
		getDetails() {
			this.$axios
				.get(
					`https://api.themoviedb.org/3/movie/464052?api_key=${process.env.VUE_APP_API_KEY}&language=pt-BR`
				)
		},
		getGeneros() {
			let filteredGenres = []
